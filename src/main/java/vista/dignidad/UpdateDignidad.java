 ...
 * @author morti
 */
public class UpdateDignidad extends javax.swing.JInternalFrame {

    /**
     * Creates
     */
    public UpdateDignidad() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Nombre del Cantón:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateDignidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateDignidad().setVisible(true);
            }
        });
    }
