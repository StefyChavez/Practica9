 ...
 * @author admi
 */
public class DeleteCandidato extends javax.swing.JInternalFrame {

    /**
     * Creates new form 
     */
    public DeleteCandidato() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Título Universitario:");

        jLabel5.setText("Código de Dignidad:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(this,"Está seguro de eliminar")==0){
            this.candidatoControl.eliminar(arg);
        }
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        ...
        Candidato candidato = this.candidatoControl.buscarCandidato(arg);
        this.jTextField2.setText(candidato.getNombre());
        this.jTextField3.setText(candidato.getApeliido());
        this.jComboBox1.getSelectedItem().toString();
        this.jTextField4.setText(candidato.getTituloUniversitario());
        this.jTextField5.setText(String.valueOf(candidato.getDignidad().getCodigo()));
    ...
    private void actualizarTable1(){
        ...
        encabezado[3]="Género";
        encabezado[4]="Titulo Universitario";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteCandidato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteCandidato().setVisible(true);
            }
        });
    }
